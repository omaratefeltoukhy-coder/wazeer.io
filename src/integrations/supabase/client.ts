  ...
  if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) {
    ...
    const stub: any = {
      auth: {
        ...
        setSession: async () => ({ data: { session: null, user: null }, error: stubError }),
        refreshSession: async () => ({ data: { session: null, user: null }, error: stubError }),
        updateUser: async () => ({ data: { user: null }, error: stubError }),
        resetPasswordForEmail: async () => ({ data: null, error: stubError }),
        exchangeCodeForSession: async () => ({ data: { session: null, user: null }, error: stubError }),
      },
      from: () => noopQuery,
